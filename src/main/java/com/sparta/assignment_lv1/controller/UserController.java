...
public class UserController {
    ...
    public ResponseEntity<MsgAndHttpStatusDto> signup(@Valid @RequestBody SignupRequestDto signupRequestDto, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            if (bindingResult.hasFieldErrors("username"))
                throw new CustomException(ErrorCode.NOT_VALIDATE_SIGNUP_USERNAME);
            else
                throw new CustomException(ErrorCode.NOT_VALIDATE_SIGNUP_PASSWORD);
        }
