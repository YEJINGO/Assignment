...
public class LikeService {
    ...
    // 1. 노트 좋아요 개수 추출
    public ResponseEntity updateNoteLike(Long noteId, UserDetailsImpl userDetails) {
    ...
    // 2. 게시물 좋아요 개수 추출
    public ResponseEntity updateCommentLike(Long commentId, UserDetailsImpl userDetails) {
        ...
        return ResponseEntity.ok(likeRepository.findAllByComment_Id(commentId).size());
    }
}
